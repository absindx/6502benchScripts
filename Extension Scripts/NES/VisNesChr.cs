...
namespace RuntimeData.Nintendo{
	public class VisCharacter : MarshalByRefObject, IPlugin, IPlugin_Visualizer{
		// IPlugin
		public string		Identifier{
			get{
				return "NES CHR Visualizer";
			}
		}
		...
		private const string	VIS_GEN_BITMAP	= "chr-bitmap";
		...
		private VisDescr[]	mDescriptors	= new VisDescr[]{
			new VisDescr(VIS_GEN_BITMAP, "CHR Bitmap", VisDescr.VisType.Bitmap,
				new VisParamDescr[]{
